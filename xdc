...
#set_property -dict { PACKAGE_PIN E16 IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L11N_T1_SRCC_15 Sch=jb[7]

set_property -dict { PACKAGE_PIN F13 IOSTANDARD LVCMOS33 } [get_ports { Y1 }]; #IO_L5P_T0_AD9P_15 Sch=jb[8]
